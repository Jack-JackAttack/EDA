...
- **Genomsnittlig lånetid:** 21.3 daggar
- **Antal lån på övertid:** 47.6 %

### Figurer
![Lån per genre](images/fig_loans_by_genre.png)
![Top-10 filialer](images/fig_top10_brances.png)
...
```bash
# klona projektet
git clone https://github.com/Jack-JackAttack/EDA.git
cd library-eda

# Skapa och akrivera virtuell miljö
python -m venv .venv
# Windows PowerShell
